 ...
 * @LastEditTime: 2025-08-07 11:15:41
 * @LastEditors: YangLiwei 1280426581@qq.com
 * @FilePath: \touchfish\zhihu\src\hooks\useMessageHandler.ts
 * Copyright (c) 2025 by YangLiwei, All Rights Reserved. 
 * @Description: 
 */
import { useEffect } from "react";
import type { ZhihuCommandsType } from "../../../type";

type Handlers = Record<string, (payload: any) => void>;

export function useMessageHandler(handlers: Handlers) {
  useEffect(() => {
    const handler = (ev: MessageEvent<ZhihuCommandsType<any>>) => {
